...
def run_codex(session, turn, prompt):
    ...
    # Passing prompt to codex seems problematic. Let's just create an actual text file, pass it via simple '< file' shell redirection instead.
