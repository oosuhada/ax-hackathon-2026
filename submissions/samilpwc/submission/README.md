...
| ROI 축 | 상세 내용 | 비고 |
|--------|-----------|------|
| **1. Delivery Cost (리서치 공수 99% 절감)** | 주니어 컨설턴트 1건 리서치 80h(약 800만원) → 1건당 평균 토큰 비용 약 2,000원(Input 100K + Output 4K Token). 인건비 대비 **3,600배 비용 효율** 발생 | **[ASSUMPTION]** |
| **2. Justification (의사결정 병목 해소)** | SOP에 근거한 객관적 리포트로 부서 간 교착 상태를 평균 14일에서 1일 이내로 단축, 프로젝트당 기회비용 약 5,000만 원 절감 | **[ASSUMPTION]** |
| **3. Audit Defensibility (감사 방어력)** | `mapping_rationale`을 통한 인과관계 증명으로 데이터 유출 및 감사 페널티 확률 5% 감소 = 기대 손실 회피 5,000만 원 | **[ASSUMPTION]** |
| **4. Liability & Risk Isolation (책임 분리)** | SOP 미확인 시 Human-in-the-Loop으로 이관하여, 환각에 의한 치명적 법적 리스크 및 Zero-Day 공격 차단 (손실 회피 1억 원 상당) | **[ASSUMPTION]** |
