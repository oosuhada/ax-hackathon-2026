...
- **ROI (비즈니스 임팩트)**: 선택지를 줄인 고객은 더 빠르게 구매 결정을 내릴 가능성이 있습니다(CVR 상승 가설). 탐색 이탈률을 낮추는 것은 물론, 핏 조건 기반 추천으로 사이즈 미스 반품 리스크를 낮춘다는 가정하에 2%p 방어 시 연간 60억 원 수준의 역물류 비용 절감 여지가 있습니다. [ASSUMPTION]
